...
sudo docker run -d -p 8080:8080 -v ~/Acuitra/:/var/local/acuitra -link dbpedia_sparql:dbpedia_sparql -link quepy:quepy -link named_entity_service:named_entity_service  -name question_service question-service
